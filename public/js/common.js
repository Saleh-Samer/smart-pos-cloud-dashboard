...
(function (global) {
  ...
  const DICT = {
    ar: {
      ...
      yesterday: 'أمس',
      refresh: 'تحديث',
      save_pdf: 'حفظ كـ PDF (بالإنجليزي)',
      pay_corrections: 'تصحيح طريقة الدفع',
      pay_fix_shift: 'فرق الوردية {from} ← {to}',
      method_cash: 'كاش',
      method_visa: 'فيزا',
      method_cliq: 'كليك',
      stock_week: 'حركة المخزون — آخر 7 أيام',
      stock_received: 'استلام',
      stock_sold: 'انباع',
      stock_wasted: 'تالف',
      stock_loss: 'خسارة التالف',
      stock_line: 'استلام {received} · انباع {sold} · تالف {wasted}',
      stock_idle: 'موجود بالمخزون وما انباع منه شي: {names}',
      waste_title: 'التالف',
      received_title: 'بضاعة استُلمت',
      waste_expired: 'منتهي الصلاحية / خرب',
      waste_damaged: 'مكسور / تالف',
    ...
    en: {
      ...
      pay_corrections: 'Payment corrections',
      pay_fix_shift: 'Shift difference {from} → {to}',
      method_cash: 'Cash',
      method_visa: 'Visa',
      method_cliq: 'CliQ',
      stock_week: 'Stock movement — last 7 days',
      stock_received: 'Received',
      stock_sold: 'Sold',
      stock_wasted: 'Wasted',
      stock_loss: 'Loss from waste',
      stock_line: 'Received {received} · sold {sold} · wasted {wasted}',
      stock_idle: 'In stock but nothing sold: {names}',
      waste_title: 'Waste',
      received_title: 'Deliveries received',
      waste_expired: 'Expired / spoiled',
      waste_damaged: 'Broken / damaged',
